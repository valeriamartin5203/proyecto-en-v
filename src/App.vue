    ...
    <div class="theme-switch p-2">
      ...
      <div class="mt-2">
        ...
        <select v-model="sonidoSeleccionado"
          ...
          <option value="/sonidos/campanas.mp3">
            🔔 Campanas
          </option>

          <option value="/sonidos/c1.mp3">
            🎵 Sonido 2
          </option>
          ...
          <div v-if="currentView === 'organizar'">
            ...
            <div class="mb-3">
              <button class="btn btn-outline-secondary me-2"
                      @click="filtro='todas'">Todas</button>

              <button class="btn btn-outline-warning me-2"
                      @click="filtro='pendientes'">Pendientes</button>

              <button class="btn btn-outline-success"
                      @click="filtro='completadas'">Completadas</button>
            </div>
